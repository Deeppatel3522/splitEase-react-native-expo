...
{/* Input Fields */}
        <View style={{
            ...
            <Text style={{fontSize: 16, color: '#FFFFFF', marginBottom: 10}}>Full Name</Text>
            <View style={{
                ...
                <View style={{alignItems: 'center', justifyContent: 'center'}}>
                    <Text ><Icon name="user-plus" size={16} color="#9CA3AF" /></Text>
                </View>
                <TextInput placeholder='Enter your full name' placeholderTextColor={'#9CA3AF'} style={{fontSize: 14, color:'#9CA3AF'}} />
            </View>
...
{/* Terms & Conditions */}
        <View style={{
            ...
            <Text style={{color: '#9CA3AF', fontSize: 12}}>By signing up, you agree to our</Text>
            <TouchableOpacity>
...
{/* Log In */}
        <View style={{
            ...
            <Text style={{color: '#9CA3AF', fontSize: 16}}>Already have an account? </Text>
            <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                <Text style={{color: '#6366F1', fontSize: 16, fontWeight: 600}}>Log In</Text>
            </TouchableOpacity>
        </View>
